...
export default function TheEndModal({ open, setOpen, data }) {
    ...
    return (
        ...
        <ModalsLayout open={open} title="صفحه  پایان" setOpen={setOpen} onOk={formik.handleSubmit}>
            <div className='w-full grid grid-cols-12 h-full overflow-hidden'>
                ...
                <div className='col-span-4 border h-full flex overflow-y-auto flex-col gap-4 p-1'>
                    {/* <div className='flex flex-col gap-2'>
                        <label className='font-bold' htmlFor="">متن پایان</label>
                    ...
                    <div className='flex flex-col gap-2'>
                        ...
                        <TextArea onChange={formik.handleChange} name='title' value={formik.values.title} rows={8} placeholder="عنوان  پایان" />
